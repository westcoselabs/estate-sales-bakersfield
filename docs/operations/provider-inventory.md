...
| -------------------- | ---------------------------------------------- | -------------------------------------- | ------------------------------------------------- |
| PostgreSQL/PostGIS   | non-Production data                            | isolated Test Neon                     | Production-scoped Neon                            |
...
Mapbox and Google Maps are superseded active targets. Historical Mapbox rows
