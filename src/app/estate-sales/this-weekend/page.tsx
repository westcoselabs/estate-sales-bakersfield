...
export async function generateMetadata({ searchParams }: Props) {
  return salesHubMetadata("estate-weekend", await searchParams);
}
export default async function EstateSalesWeekendPage({ searchParams }: Props) {
  return <DateSalesHub hubKey="estate-weekend" query={await searchParams} />;
}
