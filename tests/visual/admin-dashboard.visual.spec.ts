        ...
        <div class="admin-app">
          ...
          <aside class="admin-sidebar">
            ...
            <div class="admin-sidebar__secondary">
              ...
              <a href="#">Two-step verification</a>
              <details class="account-menu account-menu--default"><summary aria-label="Open account menu for Brandon Reed"><span class="account-avatar account-avatar--medium" role="img">BR</span><span class="account-menu__name">Brandon Reed</span></summary><div class="account-menu__popover"><div class="account-menu__identity"><span class="account-avatar account-avatar--large">BR</span><span><strong>Brandon Reed</strong><small>Account</small></span></div><a href="#">Dashboard</a><a href="#">Profile</a><button>Log out</button></div></details>
            </div>
          </aside>
          <header class="admin-topbar">
            <a class="brand admin-brand" href="#" aria-label="Estate Sales Bakersfield owner overview"><picture class="brand__logo"><source media="(max-width: 767px)" srcset="${compactLogoUrl}"><img alt="" class="brand__logo-image" height="340" src="${fullLogoUrl}" width="2000"></picture></a>
            <div class="admin-topbar__actions"><span>Owner portal</span><a class="admin-topbar__security" href="#"><svg viewBox="0 0 24 24" width="18" height="18"><path d="M12 21.25c5-2.1 7.5-5.4 7.5-9.9V5.6L12 2.75 4.5 5.6v5.75c0 4.5 2.5 7.8 7.5 9.9Z" fill="none" stroke="currentColor"/></svg><span>Security</span></a><details class="account-menu account-menu--default"><summary aria-label="Open account menu for Brandon Reed"><span class="account-avatar account-avatar--medium" role="img">BR</span><span class="account-menu__name">Brandon Reed</span></summary><div class="account-menu__popover"><div class="account-menu__identity"><span class="account-avatar account-avatar--large">BR</span><span><strong>Brandon Reed</strong><small>Account</small></span></div><a href="#">Dashboard</a><a href="#">Profile</a><button>Log out</button></div></details></div>
          </header>
...
test("admin visual system holds at desktop width", async ({
  ...
  await renderAdminFixture(page, { width: 1440, height: 800 });
  ...
  const sidebarSections = await page.evaluate(() => {
    const finalWorkspaceLink = document.querySelector(
      ".admin-sidebar__navigation .admin-nav-link:last-child",
    );
    const websiteSection = document.querySelector(".admin-sidebar__secondary");
    if (!finalWorkspaceLink || !websiteSection) return null;
    return {
      workspaceBottom: finalWorkspaceLink.getBoundingClientRect().bottom,
      websiteTop: websiteSection.getBoundingClientRect().top,
    };
  });
  expect(sidebarSections).not.toBeNull();
  expect(sidebarSections!.workspaceBottom).toBeLessThanOrEqual(
    sidebarSections!.websiteTop,
  );
