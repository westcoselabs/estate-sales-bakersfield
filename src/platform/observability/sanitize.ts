const SECRET_KEY_PATTERN =
  /(authorization|cookie|email|password|recipient|secret|token|signature|checkouturl|sessionurl|rawbody|apikey|address|coordinates|latitude|longitude|recoverycode|totp|^code$)/i;
