# Legacy Preview Verification Pointer

This path is retained only so completed historical acceptance reports keep a
valid reference. The former Vercel Preview checklist is retired and is not an
approved hosted workflow.

Do not create a Vercel Preview deployment, Preview-specific provider resource,
